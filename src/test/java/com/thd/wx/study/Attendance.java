...
public class Attendance {
    ...
    private static void appendData(Sheet sheet, int rsRows, Map<String, Map<String, Object>> mapMap) {
        Date overtimeDate = DateUtil.getStringToDate("2016-01-01 20:00:00");//开始算加班的时间点
        ...
        for (int i = 1; i < rsRows; i++) {
            ...
            //加班总时长（分钟）
            long overtimeTotalTimes = map.get(OVERTIME_TOTAL_TIMES) == null ? 0 : (Long) map.get(OVERTIME_TOTAL_TIMES);
            ...
            if (StringUtils.isNotBlank(timeText)) {
                ...
                long minutes = (toDate.getTime() - standardDate.getTime()) / (1000 * 60 * 60);//小时
                ...
                map.put(OVERTIME_TOTAL_TIMES, overtimeTotalTimes);
                mapMap.put(name, map);
            }
        }
    }
