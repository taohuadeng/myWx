...
import com.thd.wx.index.model.Picture;
...
//        System.out.println("===============================================");
    ...
    public static void Demo2() throws ClassNotFoundException {
        ...
        class1 = Class.forName("com.thd.wx.study.Person");
        System.out.println("Demo2:(写法1) 包名: " + class1.getPackage().getName() + "，"
                + "完整类名: " + class1.getName());

        //写法2
        class2 = Picture.class;
    ...
    public static void Demo5() throws IllegalArgumentException, IllegalAccessException, SecurityException, NoSuchFieldException, InstantiationException, ClassNotFoundException {
        Class<?> class1 = Class.forName("com.thd.wx.study.Person");
        ...
        personNameField.set(obj, "玉皇大帝");
        personAgeField.set(obj, "玉皇大帝");
